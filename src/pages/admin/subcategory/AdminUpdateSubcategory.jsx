...
import { getSubcategory, updateSubcategory } from "../../../Redux/ActionCreartors/SubcategoryActionCreators"
    ...
    useEffect(() => {
        (() => {
            ...
            if (SubcategoryStateData.length) {
                ...
                // let item = SubcategoryStateData.find(x => x._id === _id) in case of real backend
                if (item)
                    setData({ ...item })
            }
        })()
